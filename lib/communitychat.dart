...
//     return Scaffold(
//       appBar: AppBar(
//         actions: [IconButton(onPressed: (){}, icon: Icon(_chatEnabled?Icons.visibility:Icons.visibility_off))],
//         title: Row(
//           children: [
//             SizedBox(width: 8),
//             Expanded(
...
class _AdminChatScreenState extends State<AdminChatScreen> {
  ...
  void _toggleChatStatus() async {
    bool newStatus = !_chatEnabled;
    setState(() {
      _chatEnabled = newStatus;
    });
    await FirebaseFirestore.instance
        .collection('admin_settings')
        .doc('chat_status')
      ...
      appBar: AppBar(
        actions: [
          IconButton(
            ...
            icon: Icon(_chatEnabled ? Icons.visibility : Icons.visibility_off),
          ),
        ],
        title: Row(
          children: [
            ...
            child: StreamBuilder(
              ...
              builder: (context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    var message = messages[index];
                    bool isAdmin = message['sender'] == _adminUsername;
                    return Container(
                      alignment: isAdmin
                          ? Alignment.centerLeft
                          : Alignment.centerRight,
